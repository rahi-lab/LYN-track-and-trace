...
cd "$PROJECT_DIR" || { echo "Error: Could not navigate to $PROJECT_DIR/LYN-track-and-trace"; exit 1; }
...
# Note: bread is the internal name we use for the LYN-track-and-trace package (because it's for yeast and yeast is used in bread). wherever you see bread, it refers to the LYN-track-and-trace package.
# Note2: throughout this script, we use the sample_config file. you can find this file under LYN-track-and-trace/src/bread/config folder. feel free to edit this file to change the configurations.
...
INPUT_SEGMENTATION="~/Desktop/LPBS_track_and_trace/Data_budding_yeast/Recording_1_aka_Colony_1/colony001_segmentation.h5" # path to the input segmentation file
TRAIN_CELLGRAPH_DIR='~/Desktop/LPBS_track_and_trace/generated/cellgraphs/train/' # path to the output folder
...
INPUT_SEGMENTATION="~/Desktop/LPBS_track_and_trace/Data_budding_yeast/Recording_2_aka_Colony_2/colony002_segmentation.h5" # path to the input segmentation file
VALID_CELLGRAPH_DIR='~/Desktop/LPBS_track_and_trace/generated/cellgraphs/valid/' # path to the output folder
...
INPUT_SEGMENTATION="~/Desktop/LPBS_track_and_trace/Data_budding_yeast/Recording_3_aka_Colony_3/colony003_segmentation.h5" # path to the input segmentation file
TEST_CELLGRAPH_DIR='~/Desktop/LPBS_track_and_trace/generated/cellgraphs/test/' # path to the output folder
...
TRAIN_ASSIGNMENT_GRAPH_DIR='~/Desktop/LPBS_track_and_trace/generated/assgraphs/train' # path to the cellgraphs folder
...
VALID_ASSIGNMENT_GRAPH_DIR='~/Desktop/LPBS_track_and_trace/generated/assgraphs/valid'  # path to the cellgraphs folder
...
TEST_ASSIGNMENT_GRAPH_DIR='~/Desktop/LPBS_track_and_trace/generated/assgraphs/test'  # path to the cellgraphs folder
